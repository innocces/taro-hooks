...
const Alibaba: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
Alibaba.displayName = 'Alibaba';

Alibaba.defaultProps = {
  size: 18,
  style: {},
};
