...
const Insertrowabove: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
Insertrowabove.defaultProps = {
  size: 18,
  style: {}
}

export default Insertrowabove;
