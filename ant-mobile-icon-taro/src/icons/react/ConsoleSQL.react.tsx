...
const ConsoleSQL: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
ConsoleSQL.displayName = 'ConsoleSQL';

ConsoleSQL.defaultProps = {
  size: 18,
  style: {},
};

export default ConsoleSQL;
