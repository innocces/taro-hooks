...
const Reloadtime: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
Reloadtime.displayName = 'Reloadtime';

Reloadtime.defaultProps = {
  size: 18,
  style: {}
}

export default Reloadtime;
