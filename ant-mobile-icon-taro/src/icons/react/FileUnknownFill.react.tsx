...
const FileUnknownFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
FileUnknownFill.displayName = 'FileUnknownFill';

FileUnknownFill.defaultProps = {
  size: 18,
  style: {}
}
