...
const InsuranceFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
InsuranceFill.displayName = 'InsuranceFill';

InsuranceFill.defaultProps = {
  size: '1em',
  style: {}
}
