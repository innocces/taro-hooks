...
const BehanceCircleFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
BehanceCircleFill.displayName = 'BehanceCircleFill';

BehanceCircleFill.defaultProps = {
  size: 18,
  style: {}
}
