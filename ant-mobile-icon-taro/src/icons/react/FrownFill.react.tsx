...
const FrownFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
FrownFill.displayName = 'FrownFill';

FrownFill.defaultProps = {
  size: 18,
  style: {},
};
