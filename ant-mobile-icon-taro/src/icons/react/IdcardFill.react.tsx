...
const IdcardFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
IdcardFill.displayName = 'IdcardFill';

IdcardFill.defaultProps = {
  size: 18,
  style: {}
}
