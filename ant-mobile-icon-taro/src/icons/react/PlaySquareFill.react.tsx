...
const PlaySquareFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
PlaySquareFill.displayName = 'PlaySquareFill';

PlaySquareFill.defaultProps = {
  size: 18,
  style: {}
}
