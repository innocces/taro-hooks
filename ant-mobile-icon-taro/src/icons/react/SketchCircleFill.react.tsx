...
const SketchCircleFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
SketchCircleFill.displayName = 'SketchCircleFill';

SketchCircleFill.defaultProps = {
  size: 18,
  style: {},
};
