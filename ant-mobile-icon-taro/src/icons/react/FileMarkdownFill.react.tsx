...
const FileMarkdownFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
FileMarkdownFill.displayName = 'FileMarkdownFill';

FileMarkdownFill.defaultProps = {
  size: 18,
  style: {}
}
