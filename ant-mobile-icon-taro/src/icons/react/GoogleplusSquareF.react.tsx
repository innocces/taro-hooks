...
const GoogleplusSquareF: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
GoogleplusSquareF.displayName = 'GoogleplusSquareF';

GoogleplusSquareF.defaultProps = {
  size: 18,
  style: {},
};

export default GoogleplusSquareF;
