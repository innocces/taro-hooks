...
const EUROCircleFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
EUROCircleFill.displayName = 'EUROCircleFill';

EUROCircleFill.defaultProps = {
  size: 18,
  style: {},
};
