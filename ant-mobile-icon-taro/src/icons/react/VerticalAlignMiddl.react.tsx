...
const VerticalAlignMiddl: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
VerticalAlignMiddl.displayName = 'VerticalAlignMiddl';

VerticalAlignMiddl.defaultProps = {
  size: 18,
  style: {}
}

export default VerticalAlignMiddl;