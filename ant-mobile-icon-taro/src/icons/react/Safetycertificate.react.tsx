...
const Safetycertificate: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
Safetycertificate.defaultProps = {
  size: 18,
  style: {}
}
