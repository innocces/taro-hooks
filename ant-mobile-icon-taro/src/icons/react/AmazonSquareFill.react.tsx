...
const AmazonSquareFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
AmazonSquareFill.displayName = 'AmazonSquareFill';

AmazonSquareFill.defaultProps = {
  size: '1em',
  style: {}
}
