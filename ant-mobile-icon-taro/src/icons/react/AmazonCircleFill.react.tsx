...
const AmazonCircleFill: FC<ITaroIconProps> = ({
  size,
  style = {},
  color,
  usePX,
...
AmazonCircleFill.displayName = 'AmazonCircleFill';

AmazonCircleFill.defaultProps = {
  size: 18,
  style: {}
}
