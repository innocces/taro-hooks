...
const Aliwangwang: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
Aliwangwang.displayName = 'Aliwangwang';

Aliwangwang.defaultProps = {
  size: 18,
  style: {},
};
