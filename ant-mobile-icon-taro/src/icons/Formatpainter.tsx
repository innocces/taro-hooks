...
const Formatpainter: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
Formatpainter.displayName = 'Formatpainter';

Formatpainter.defaultProps = {
  size: 18,
  style: {},
};
