...
const Dingtalk: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
Dingtalk.displayName = 'Dingtalk';

Dingtalk.defaultProps = {
  size: 18,
  style: {},
};
