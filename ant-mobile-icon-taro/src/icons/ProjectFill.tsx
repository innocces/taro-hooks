...
const ProjectFill: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
ProjectFill.displayName = 'ProjectFill';

ProjectFill.defaultProps = {
  size: 18,
  style: {},
};
