...
const DribbbleSquareFill: FC<ITaroIconProps> = ({
  size,
  style,
  color,
  usePX,
...
DribbbleSquareFill.displayName = 'DribbbleSquareFill';

DribbbleSquareFill.defaultProps = {
  size: 18,
  style: {},
};
