...
const typeDocEntries =
    readdirSync(packagesPath)
        .filter(
            (v) =>
                !['app', 'blueimp-canvas-to-blob', 'compressorjs'].includes(v))
    ...
    [
      ...
      ({
        ...
        beforeDefaultRemarkPlugins :
            [ [ require('./remark/code'), getOptions() ] ],
      }),
    ],
    [
      ...
      ({
        ...
        blog : {
          ...
          feedOptions : {
            type : 'all',
            copyright :
                `Copyright © ${new Date().getFullYear()} Innocces, Inc.`,
          },
        },
        theme : {
  ...
  themeConfig :
      ...
      ({
        ...
        footer : {
              ...
              items : [
                {
                  label : 'buy me coffee',
                  href :
                      'https://www.buymeacoffee.com/innocces?ref=widget-1376490',
                },
          ...
          copyright : `Copyright © ${
              new Date().getFullYear()} Taro-hooks, Inc. Built with Innocces.`,
        },
        announcementBar : {
