...
export declare type VueInstance<
  M = Record<string, any>,
  P = Record<string, any>,
> = CombinedVueInstance<
  VueCtor,
...
export interface ReactPageComponent<T = PageProps>
  extends ComponentClass<T>,
    Show,
    PageInstance {}
export interface ReactPageInstance<T = PageProps>
  extends Component<T>,
    Show,
    PageInstance {
...
export interface ReactAppInstance<T = AppInstance>
  extends Component<T>,
    Show,
    AppInstance {}
...
export interface AppInstance extends Show {
  ...
  mount?(
    component: React.ComponentClass | ComponentOptions<VueCtor> | Vue3Component,
    id: string,
    cb: (...args: any[]) => void,
  ): void;
  mount?(
