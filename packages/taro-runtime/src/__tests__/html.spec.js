...
describe('html with <style>', () => {
  ...
  it('id selector', () => {
    ...
    expect(el.style.cssText).toBe(
      'color: red;font-size: 10;transition: color ease-in 300ms;border: 1px solid red;',
    );
  });
  ...
  it('class selector', () => {
    ...
    expect(el0.style.cssText).toBe(
      'background: red;border: 1px;padding: 10px;',
    );
    expect(el1.style.cssText).toBe(
      'font-weight: bold;color: red;font-size: 10;',
    );
