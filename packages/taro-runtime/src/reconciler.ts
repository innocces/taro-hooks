...
> {
  ...
  removeChild?(
    parent: DOMNode,
    child: DOMNode | TextElement,
    oldChild: DOMNode | TextElement,
  ): void;

  insertBefore?(
    parent: DOMNode,
    child: DOMNode | TextElement,
    refChild?: DOMNode | TextElement | null,
  ): void;
  ...
  getLifecyle(
    instance: Instance,
    lifecyle: keyof PageInstance,
  ): Func | undefined | Array<Func>;
